...
<ul id="jj_sl_navigation">
    <?php if ($params->get('facebook')==1) { ?><li class="facebook"><a href="<?php echo $params->get('facebook_link'); ?>" <?php echo $target; ?>><?php echo JText::_('JJ_SOCIAL_SLIDER_VIA_FACEBOOK'); ?></a></li><?php }
